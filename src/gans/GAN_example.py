...
# optimizes algorithm, but not needed in our case
...
assert dataset
# THIS IS FUCKING STUPID - it does nothing, since in production asserts are
# discarded
...
discriminator_latent_maps = int(opt.ndf)
