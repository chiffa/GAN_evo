"""
Code for the management of the Frechnet inception distance and inception score together for GAN
quality evaluation.
...
from src.fid_is_calc.fid import calculate_frechet_distance, torch_cov
