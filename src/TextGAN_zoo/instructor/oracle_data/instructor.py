    ...
    def init_model(self):
        ...
        if cfg.dis_pretrain:
            ...
            if cfg.CUDA:
                ...
                self.dis.load_state_dict(torch.load(cfg.pretrained_dis_path, map_location=torch.device('cpu')))
        if cfg.gen_pretrain:
            ...
            if cfg.CUDA:
                ...
                self.gen.load_state_dict(torch.load(cfg.pretrained_gen_path, map_location=torch.device('cpu')))
